...
<head>
    ...
    <title>500 - Erro interno | {{ config('app.name', 'Laravel') }}</title>
...
<body class="bg-[#0a0a0a] text-white flex flex-col min-h-screen items-center justify-center">
    <div class="flex flex-col items-center gap-6 text-center px-4">
        <span class="text-7xl sm:text-8xl font-bold text-white/10">500</span>
        <div class="flex flex-col items-center gap-2">
            <h1 class="text-xl sm:text-2xl font-semibold">Erro interno do servidor</h1>
